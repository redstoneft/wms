...
* Nueva tarea (handheld): el operador crea su propia tarea de surtido, conteo o acomodo indicando obligatoriamente para qué; el armado también exige el motivo. Surtido libre: un pedido nuevo se crea en el handheld y se arma escaneando tarimas (completas o por cantidad) en distintos momentos, hasta cerrarlo.

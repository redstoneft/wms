...
* Armado: órdenes de conversión de insumo a producto terminado (`/assembly` en oficina, `Almacén → Armado` en handheld): consume pallets de entrada, crea pallets nuevos con su factor de empaque, merma como incidencia, tareas de acomodo, historial.

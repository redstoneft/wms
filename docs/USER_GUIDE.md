...
* Nueva tarea (handheld): el operador crea su propia tarea de surtido, conteo o acomodo indicando obligatoriamente para qué; el armado también exige el motivo.

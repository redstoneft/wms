    ...
    <div>
      ...
      <Modal open={!!token} onClose={() => setToken(null)} title={`Estación de impresión · ${token?.printer ?? ''}`}>
        ...
        <ol className="mt-3 list-decimal space-y-1 pl-5 text-sm text-slate-700">
          ...
          <li>Si la PC tiene Python instalado (python.org, "Add Python to PATH"), corre como programa en una ventana negra: imprime por el driver normal de Windows y además atiende a la app de etiquetas SAE (127.0.0.1:9101), así las dos apps comparten la Zebra. Si no hay Python, abre la estación del navegador: ahí presionas <b>Elegir la Zebra</b> la primera vez.</li>

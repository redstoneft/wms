...
export const labelsApi = {
  ...
  sheetUrl: (q: { rack_id?: string; zone_id?: string; codes?: string; title?: string }) => `/api/labels/locations.html?${new URLSearchParams(q as Record<string, string>)}`,
  zplUrl: (q: { rack_id?: string; zone_id?: string; codes?: string; title?: string }) => `/api/labels/locations.zpl?${new URLSearchParams(q as Record<string, string>)}`,
  embarqueUrl: (q: { rack_id?: string; zone_id?: string; codes?: string; title?: string }) => `/api/labels/locations.embarque.json?${new URLSearchParams(q as Record<string, string>)}`,
